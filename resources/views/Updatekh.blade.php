		...
		<div class="page-content">
							...
							<ul class="navigation navigation-main navigation-accordion">
								...
								<li>
									...
									<ul>
                                        ...
                                        <li class="active"><a href="{{route('getupdatekh')}}">Chỉnh sửa khách hàng</a></li>
									</ul>
								</li>
								<li>
            ...
            <div class="row">
						<div class="col-md-6">
							...
							<!-- Basic layout-->
							<form action="{{route('postupdatekh')}}" class="form-horizontal" method="post">
                            @csrf
								<div class="panel panel-flat">
									<div class="panel-heading">
										<h5 class="panel-title">Nhập các thông tin để chỉnh sửa khách hàng</h5>
