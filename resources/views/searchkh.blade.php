						...
						<div class="category-content no-padding">
							<ul class="navigation navigation-main navigation-accordion">
								...
								<li>
									...
									<ul>
                                        <li class="active"><a href="{{route('getsearchkh')}}">Tìm kiếm khách hàng</a></li>
								...
								<li>
									...
									<ul>
                                        <li ><a href="{{route('getsearchdh')}}">Tìm kiếm đơn hàng</a></li>
    ...
    $(document).ready(function(){
     ...
     $('#country_name').keyup(function(){ //bắt sự kiện keyup khi người dùng gõ từ khóa tim kiếm
      ...
      if(query != '') //kiểm tra khác rỗng thì thực hiện đoạn lệnh bên dưới
      {
       ...
       $.ajax({
        url:"{{ route('searchkh') }}", // đường dẫn khi gửi dữ liệu đi 'search' là tên route mình đặt bạn mở route lên xem là hiểu nó là cái j.
