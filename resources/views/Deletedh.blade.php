		...
		<div class="page-content">
							...
							<ul class="navigation navigation-main navigation-accordion">
								...
								<li >
                                    ...
                                    <li><a href="{{route('getadddh')}}">Thêm đơn hàng</a></li>
										<li class="active"><a href="{{route('getdeletedh')}}">Xóa đơn hàng</a></li>
            ...
            <div class="row">
						<div class="col-md-6">
							...
							<!-- Basic layout-->
							<form action="{{route('postdeletedh')}}" class="form-horizontal" method="post">
                            @csrf
								<div class="panel panel-flat">
									<div class="panel-heading">
										<h5 class="panel-title">Nhập các thông tin để xóa đơn hàng</h5>
