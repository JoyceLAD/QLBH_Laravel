		...
		<div class="page-content">
						...
						<div class="category-content no-padding">
							<ul class="navigation navigation-main navigation-accordion">
								...
								<li>
									...
									<ul>
                                    <li class="active"><a href="{{route('getadddh')}}">Thêm đơn hàng</a></li>
            ...
            <div class="row">
						<div class="col-md-6">
							...
							<!-- Basic layout-->
							<form action="{{route('postadddh')}}" class="form-horizontal" method="post">
                            @csrf
								<div class="panel panel-flat">
									<div class="panel-heading">
										<h5 class="panel-title">Nhập các thông tin để thêm đơn hàng</h5>
									...
									<div class="panel-body">
                                        ...
                                        <div class="form-group">
											<label class="col-lg-3 control-label">Tên đơn hàng:</label>
                                            <div class="col-lg-9">
                            ...
                            <!-- @if(session('role'))
                                {{ \App\Models\Phanquyen::check_own(session('userId')->id_tk) }}
                            @endif -->
