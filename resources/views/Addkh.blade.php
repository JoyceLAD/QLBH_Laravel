		...
		<div class="page-content">
						...
						<div class="category-content no-padding">
							<ul class="navigation navigation-main navigation-accordion">
								...
								<li>
									...
									<ul>
										<li class="active"><a href="{{route('getaddkh')}}">Thêm khách hàng</a></li>
            ...
            <div class="row">
						<div class="col-md-6">
							...
							<!-- Basic layout-->
							<form action="{{route('postaddkh')}}" class="form-horizontal" method="post">
                            @csrf
								<div class="panel panel-flat">
									<div class="panel-heading">
										<h5 class="panel-title">Nhập các thông tin để thêm khách hàng</h5>
									...
									<div class="panel-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-9">
												...
												@if ($errors->has('id_ct'))
												<span class="text-danger">{{ $errors->first('id_ct') }}</span>
												@endif
										...
										<div class="form-group">
                                            ...
                                            <div class="col-lg-9">
												...
												@if ($errors->has('nghe_nghiep'))
												<span class="text-danger">{{ $errors->first('nghe_nghiep') }}</span>
												@endif
