		...
		<div class="page-content">
							...
							<ul class="navigation navigation-main navigation-accordion">
                                ...
                                <li>
									...
									<li><a href="{{route('getaddcty')}}">Thêm công ty</a></li>
                                        ...
                                        <li class="active"><a href="{{route('getupdatecty')}}">Chỉnh sửa công ty</a></li>
									</ul>
								</li>
								<!-- /page kits -->
            ...
            <div class="row">
						<div class="col-md-6">
							...
							<!-- Basic layout-->
							<form action="{{route('postupdatecty')}}" class="form-horizontal" method="post">
                            @csrf
								<div class="panel panel-flat">
									<div class="panel-heading">
										<h5 class="panel-title">Nhập các thông tin để xóa công ty</h5>
									...
									<div class="panel-body">
										<div class="form-group">
											<label class="col-lg-3 control-label">Mã công ty:</label>
                                            <div class="col-lg-9">
												<input type="text" class="form-control" placeholder="" name="id_ct">
												@if ($errors->has('id_ct'))
												<span class="text-danger">Thiếu mã công ty</span>
												@endif
                                        ...
                                        <div class="form-group">
                                        <label class="col-lg-3 control-label">Tên công ty muốn sửa:</label>
                                            <div class="col-lg-9">
												<input type="text" class="form-control" placeholder="" name="ten_congty">
												@if ($errors->has('ten_congty'))
												<span class="text-danger">Thiếu tên công ty</span>
												@endif
