		...
		<div class="page-content">
						...
						<div class="category-content no-padding">
							<ul class="navigation navigation-main navigation-accordion">
                                ...
                                <li>
									...
									<ul>
									<li class="active"><a href="{{route('getaddcty')}}">Thêm công ty</a></li>
            ...
            <div class="row">
						<div class="col-md-6">
							...
							<!-- Basic layout-->
							<form action="{{route('postaddcty')}}" class="form-horizontal" method="post">
                            @csrf
								<div class="panel panel-flat">
									<div class="panel-heading">
										<h5 class="panel-title">Nhập các thông tin để thêm công ty</h5>
